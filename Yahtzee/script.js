...
document.querySelector('.p2BottomScoredP').textContent = p2TOK + p2Caree + p2Chance + p2FullHouse + p2GStraat + p2KStraat + p2Yahtzee; 
document.querySelector('.p2TopScoredP').textContent = p2score1 + p2score2 + p2score3 + p2score4 + p2score5 + p2score6; 
if(p2scoreTop >= 63){document.querySelector('.p2BonusP').textContent = '35';}
document.querySelector('.p2TotaalP').textContent = p2TOK + p2Caree + p2Chance + p2FullHouse + p2GStraat + p2KStraat + p2Yahtzee + p2score1 + p2score2 + p2score3 + p2score4 + p2score5 + p2score6 + p2bonus;}
} else {
rollsLeft = 3; 
...
document.querySelector('.p1BottomScoredP').textContent = p1TOK + p1Caree + p1Chance + p1FullHouse + p1GStraat + p1KStraat + p1Yahtzee; 
document.querySelector('.p1TopScoredP').textContent = p1score1 + p1score2 + p1score3 + p1score4 + p1score5 + p1score6; 
if(p1scoreTop >= 63){document.querySelector('.p1BonusP').textContent = '35';};
document.querySelector('.p1TotaalP').textContent = p1TOK + p1Caree + p1Chance + p1FullHouse + p1GStraat + p1KStraat + p1Yahtzee + p1score1 + p1score2 + p1score3 + p1score4 + p1score5 + p1score6 + p1bonus;
}}}; 
turnFunction(); 
...
function Countnumbers(number, diceScore){ 
    ...
    if(diceScore.classList.contains('p1Possible')){
    diceScore.textContent = punten;}
    else if(diceScore.classList.contains('p2Possible')){
    diceScore.textContent = punten;
    }}
    ...
    for(let i = 0; i < 5; i++){ 
            ...
            for (let j = 0; j < 6; j++){ 
                ...
                if(opeenVolgendeWaarden == 5){ 
                    gStreetP1 = true; 
                } else{document.querySelector('.p1GStraatP').textContent = '0';}; 
                if(kStreetP2){document.querySelector('.p1KStraatP').textContent = '30'}; 
                if(gStreetP2){document.querySelector('.p1GStraatP').textContent = '40'}; 
            }; 
            for(let j = 0; j <= 6; j++){ 
                sameDices = 0; 
                for(let k = 0; k<5; k++){ 
...
p1score1 = Number(score1P1.textContent);  
turnFunction(); 
}); 
...
p1score2 = Number(score2P1.textContent); 
turnFunction(); 
}); 
...
p1score3 = Number(score3P1.textContent); 
turnFunction(); 
}); 
...
p1score4 = Number(score4P1.textContent); 
turnFunction(); 
}); 
...
p1score5 = Number(score5P1.textContent); 
turnFunction(); 
}); 
...
p1score6 = Number(score6P1.textContent); 
turnFunction(); 
}); 
...
p12core1 = Number(score1P2.textContent); 
turnFunction(); 
}); 
...
p2score2 = Number(score2P2.textContent); 
turnFunction(); 
}); 
...
p2score3 = Number(score3P2.textContent); 
turnFunction(); 
}); 
...
p2score4 = Number(score4P1.textContent); 
turnFunction(); 
}); 
...
p2score5 = Number(score5P2.textContent); 
turnFunction(); 
}); 
...
p2score6 = Number(score6P2.textContent); 
turnFunction(); 
}); 
...
p2Chance = Dices[0] + Dices[1] + Dices[2] + Dices[3] + Dices[4]; 
turnFunction(); 
}); 
